...
>we now have out working datasets for each sex of each species, and we can perform dimension reduction, using a pca to extract coordinates that will be used in assigning breed status.
